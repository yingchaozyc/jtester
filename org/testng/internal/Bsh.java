...
/**
 * beanshell表达式解析。后续可以看看。 @TODO
 * 
 * @date 2014-5-15 下午4:56:37 
 */
...
public class Bsh implements IBsh {
	...
	private void setContext(Interpreter interpreter, Method method,
			Map<String, String> groups, ITestNGMethod tm) {
		try {
	...
	private void resetContext(Interpreter interpreter) {
		try {
			...
			Utils.log("bsh.Interpreter", 2, "Cannot reset interpreter:"
